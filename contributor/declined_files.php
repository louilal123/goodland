                ...
                <div class="container-fluid"> <!--begin::Row-->
                        ...
                        <div class="col-lg-12 connectedSortable">
                            <div class="card mb-4">
                                <div class="card-header">
                                    <h3 class="card-title">My Declined File Submissions</h3>
                                </div>
                                <div class="card-body">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                            <a href="#" class="btn btn-info btn-md viewBtn ml-1" name="viewPdf">
                                <i class="bi bi-eye"></i> View
                            </a>
                            <a href="#" class="btn btn-danger btn-md viewBtn ml-1" name="viewPdf">
