...
<nav class="app-header navbar navbar-expand bg-white opacity-90" > <!--begin::Container-->
                <div class="container-fluid" style="border: 0px !important;"> <!--begin::Start Navbar Links-->
                    ...
                    <ul class="navbar-nav ms-auto"> 
                        <li class="nav-item"> <a class="nav-link text-black " data-widget="navbar-search" href="#" role="button"> <i class="fas fa-search"></i> </a> </li> <!--end::Navbar Search--> <!--begin::Messages Dropdown Menu-->
                        <li class="nav-item dropdown"> <a class="nav-link text-black" data-bs-toggle="dropdown" href="#"> <i class="fas fa-chat-text"></i> <span class="navbar-badge badge text-bg-danger">3</span> </a>
                      ...
                      <li class="nav-item dropdown user-menu"> <a href="#" class="nav-link text-black dropdown-toggle" data-bs-toggle="dropdown"> 
