    ...
    <div class="container">
      <div class="row">
          ...
          <div class="container">
            <div class="row gy-4">
              <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center ">
                <h1 data-aos="fade-up " style="font-weight: bold !important;">Place, People, and Art-based Model</h1>
        ...
        <section id="projects" class="projects section">
          <div class="container">
            <div class="row gy-4">
            <div class="col-lg-12 order-1 order-lg-1 hero-img d-flex flex-column justify-content-center" data-aos="zoom-out">
                <img src="assets/img/method.png"  class="img-fluid" >
              </div>
            </div>
          </div>
          ...
          <div class="container">
            <div class="row gy-4">
              <div class="col-lg-12 order-2 order-lg-1 d-flex flex-column justify-content-center ">
                <h1 data-aos="fade-up " style="font-weight: bold !important;">Place, People, and Art-based Model</h1><br>
        ...
        <section id="projects" class="projects section">
          <div class="container">
            <div class="row gy-4">
              <div class="col-lg-12 order-2 order-lg-1 d-flex flex-column justify-content-center ">
                <h1 data-aos="fade-up " style="font-weight: bold !important;">The Model in Practice</h1><br>
              ...
              <div class="col-lg-12 order-1 order-lg-1 hero-img d-flex flex-column justify-content-center" data-aos="zoom-out">
                <img src="assets/img/method1.png"  class="img-fluid" >
              </div>
            </div>
