                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <?php if ($file['status'] == 'Pending'): ?>
                                <a href="classes/approve_file.php?id=<?php echo $file['id']; ?>" class="btn btn-success btn-sm">
                                    <i class="bi bi-check-square"></i> Approve</a>
                                <a href="classes/decline_file.php?id=<?php echo $file['id']; ?>" class="btn btn-warning btn-sm">
                                    <i class="bi bi-x-square"></i> Decline</a>
                                <button class="btn btn-info btn-sm viewfileBtn" data-bs-toggle="modal" data-bs-target="#viewfileModal">
