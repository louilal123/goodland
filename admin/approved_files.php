                ...
                <form method="POST" action="classes/file_action.php">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="declineRemarks" name="remarks" rows="3" required>
                            We have noticed that your file doesn't adhere to our user upload agreement.</textarea>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Close</button>
                        <button type="submit" class="btn btn-warning" name="addToPendingBtn">Add To Pending</button>
                    </div>
                </form>
            </div>
        </div>
