            ...
            <div class="row d-flex align-items-center justify-content-center h-100">
                <div class="col-md-7 col-lg-5 col-xl-5 offset-xl-1 mt-5 mb-5">
                    <div class="card">
                        ...
                        <p class="text-success text-center mb-4">We have sent a 6-digit OTP to your mobile number.

<?php if ($phone): ?>
    <?php 
                    // Masking the phone number, showing first 4 digits and last 4 digits
...
<?php endif; ?>
                        ...
                        <form action="classes/verify_sms_otp.php" method="POST">
