            ...
            <div class="modal-body">
                ...
                <form method="POST" action="classes/file_action.php">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-warning" name="recycleBtn">Recycle</button>
                    </div>
                </form>
            </div>
        </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form method="POST" action="classes/file_action.php">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Close</button>
                        <button type="submit" class="btn btn-success" name="reconsiderBtn">Move to Pending</button>
                    </div>
                </form>
            </div>
        </div>
