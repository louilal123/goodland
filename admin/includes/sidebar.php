                ...
                <nav class="mt-4"> <!--begin::Sidebar Menu-->
                    <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item pb-1"> <a href="#" class="nav-link "> 
                            ...
                            <li class="nav-item pb-1"> <a href="website_visitors" class="nav-link  <?= $page == 'website_visitors.php' ? '  bg-primary text-white  ':'' ?>"> 
                            ...
                            <li class="nav-item pb-1"> <a href="messages" class="nav-link   <?= $page == 'messages.php' ? '  bg-primary text-white  ':'' ?>"> 
                            ...
                            <ul class="nav nav-treeview ">
                               ...
                               <li class="nav-item"> <a href="" class="nav-link   <?= $page == '.php' ? '
                                 bg-primary text-white  ':'' ?>"> 
                                   <!-- <i class="nav-icon ml-2 fas fa-hourglass"></i> -->
                                       <p>Daily</p>
                                   </a> </li>
                               <li class="nav-item"> <a href="" class="nav-link   <?= $page == '.php' ? '  bg-primary text-white  ':'' ?>"> 
                                   <!-- <i class="nav-icon ml-2 fas fa-circle"></i> -->
                                       <p>Monthly</p>
                                   </a> </li>
                               <li class="nav-item"> <a href="" class="nav-link   <?= $page == '.php' ? '  bg-primary text-white  ':'' ?>"> 
                        ...
                        <li class="nav-item pb-1"> <a href="manageadmins" class="nav-link   <?= $page == 'manageadmins.php' ? '  bg-primary text-white  ':'' ?>"> 
                            <i class="nav-icon ml-2 "><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-users"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg></i>
                                <p class="">System Users</p>
                            </a> </li>

                          
                        <li class="nav-item pb-1"> <a href="settings" class="nav-link   <?= $page == 'settings.php' ? '  bg-primary text-white  ':'' ?>"> 
