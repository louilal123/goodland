                ...
                <nav class="mt-4"> <!--begin::Sidebar Menu-->
                    <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu" data-accordion="false">
                        <li class="nav-item pl-2  pb-1 "> 
                            ...
                            <li class="nav-item pl-2 pb-1"> <a href="sensor_data"
                             class="nav-link   <?= $page == 'sensor_data.php' ? '  bg-primary text-white  ':'' ?>"> 
                           <i class="nav-icon ml-2"> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                        ...
                        <li class="nav-item pl-2 pb-1"> <a href="projects" class="nav-link  <?= $page == 'projects.php' ? ' bg-primary text-white  ':'' ?>"> 
                            <i class="nav-icon ml-2"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#FAF9F6"
                             ...
                             <line x1="12" y1="11" x2="12" y2="17"></line><line x1="9" y1="14" x2="15" y2="14"></line></svg></i> 
                             <p class="">Manage Projects
                            ...
                            <li class="nav-item pl-2 pb-1"> <a href="managereports" class="nav-link <?= $page == 'managereports.php' ? '  bg-primary text-white  ':'' ?>"> 
                            <i class="nav-icon ml-2"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#FAF9F6" 
                        ...
                        <li class="nav-item pl-2 pb-1"> <a href="systemsetting" class="nav-link   <?= $page == 'systemsetting.php' ? '  bg-primary text-white  ':'' ?>"> 
